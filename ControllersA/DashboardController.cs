...
namespace Khareedo.Controllers
{
    public class DashboardController : Controller
    {
        ...
        {          
            ...
            return View("~/Views/ViewsA/Dashboard/Index.cshtml");
        }
        ...
        public JsonResult GetSalesPerDay()
        {
            ...
            {
                // Convertir la fecha al formato "YYYY-MM-DD" y asegurar que sea una cadena
                string date = item.period.HasValue ? item.period.Value.ToString("yyyy-MM-dd") : string.Empty;
        ...
        public JsonResult GetOrderPerDay()
        {
            ...
            foreach (var item in data)
            {
                ...
                string date = item.Order_Date.HasValue ? item.Order_Date.Value.ToString("yyyy-MM-dd") : string.Empty;
